...
The first subject is the entire [Window Scene](../../core-concepts/scenes-and-spatial-layouts.md#scenes-window) and the webpage itself.
...
Example based on the [Quick Example](../../quick-example/index.md): a Window Scene with a translucent material background and rounded corners
