...
See ["Step 2: Add the WebSpatial App Build Tool"](./step-2-add-build-tool-for-packaged-webspatial-apps/index.md) for how to use it.
...
These plugins integrate with popular third-party toolchains to simplify setup and apply [essential performance optimizations and sensible defaults](./step-3-integrate-webspatial-sdk-into-web-build-tools/add-optimizations-and-defaults-to-web-build-tools.md).
