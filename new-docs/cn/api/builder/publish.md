...
提交 visionOS App Store 必须的参数，来自 [Apple 开发者账号控制台中开发者信息里的账号邮箱](../../how-to/app-store-connect.md#prerequisites)。

### `--p`

提交 visionOS App Store 必须的参数，来自 Apple 开发者账号的 [app-specific password](https://support.apple.com/102654)。

### `--teamId`

提交 visionOS App Store 必须的参数，来自 [Apple 开发者账号控制台中开发者信息里的 Team ID](../../how-to/app-store-connect.md#prerequisites)。

### `--bundle-id`

提交 visionOS App Store 必须的参数，来自[在 Apple 开发者账号控制台上注册 App 获取到的 Bundle ID](../../how-to/app-store-connect.md#prerequisites)。

### `--version`

提交 visionOS App Store 必须的参数，必须大于 App Store Connect 上提交过的版本。
