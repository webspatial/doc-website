...
<Image img="/assets/intro/intro-4-2.jpeg" alt="image" />
...
<Image img="/assets/intro/intro-4-3.png" alt="image" />

For example, you can build an actual 3D cube using plain `div` elements:

<Image img="/assets/intro/intro-4-4.jpeg" alt="image" />
...
<Image img="/assets/intro/intro-4-5.png" alt="image" />
...
<Image img="/assets/intro/intro-4-6.jpeg" alt="image" />
...
<Image img="/assets/intro/intro-4-7.jpeg" alt="image" />
...
<Image img="/assets/intro/intro-4-8.gif" alt="image" />
