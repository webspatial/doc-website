...
<div className="row">
  <div className="col col--6">
    <Image img={require("/assets/intro/intro-3-1.png")} alt="" />
  </div>
  <div className="col col--6">
    <Image img={require("/assets/intro/intro-3-2.png")} alt="" />
  </div>
</div>
...
<div className="row">
  <div className="col col--6">
    <Image img={require("/assets/intro/intro-3-3.png")} alt="" />
  </div>
  <div className="col col--6">
    <Image img={require("/assets/intro/intro-3-4.png")} alt="" />
  </div>
</div>

<div className="row">
  <div className="col col--6">
    <Image img={require("/assets/intro/intro-3-5.png")} alt="" />
  </div>
  <div className="col col--6">
    <Image img={require("/assets/intro/intro-3-6.png")} alt="" />
  </div>
</div>
...
<div className="row">
  <div className="col col--6">
    <Image img={require("/assets/intro/intro-3-9.png")} alt="" />
  </div>
  <div className="col col--6">
    <Image img={require("/assets/intro/intro-3-10.png")} alt="" />
  </div>
</div>
...
<Image img={require("/assets/intro/intro-3-11.png")} alt="" />
<Image img={require("/assets/intro/intro-3-12.png")} alt="" />
