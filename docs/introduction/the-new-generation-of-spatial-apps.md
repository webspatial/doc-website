...
<div className="row">
  <div className="col col--6">
    <Image img="/assets/intro/intro-2-1-1.gif" alt="intro-2-1" />
  </div>
  <div className="col col--6">
    <Image img="/assets/intro/intro-2-2.png" alt="intro-2-2" />
  </div>
</div>

<div className="row">
  <div className="col col--6">
    <Image img="/assets/intro/intro-2-3.png" alt="intro-2-3" />
  </div>
  <div className="col col--6">
    <Image img="/assets/intro/intro-2-4.png" alt="intro-2-4" />
  </div>
</div>
...
<div className="row">
  <div className="col col--6">
    <Image img="/assets/intro/intro-2-5.png" alt="intro-2-5" />
    <p className="text--center">Desktop apps</p>
  </div>
  <div className="col col--6">
    <Image img="/assets/intro/intro-2-6.png" alt="intro-2-6" />
