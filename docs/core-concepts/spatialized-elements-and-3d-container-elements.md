...
1. **Dynamic backgrounds**
   ...
   <Image src="/assets/concepts/4-1.png" alt="Scene Example 4" />
...
2. **Spatial elevation**
   ...
   <Image src="/assets/concepts/4-2.png" alt="Scene Example 4" />
...
2. If the parent element has been elevated and rotated in 3D space, child elements can continue to be elevated and rotated on that basis.
   ...
   <Image src="/assets/concepts/4-6.png" alt="Scene Example 4" />
...
- **Static 3D content containers**
  ...
  <Image src="/assets/concepts/4-7.png" alt="Scene Example 4" />
...
<Image src="/assets/concepts/4-9.png" alt="Scene Example 4" />
