...
> <div className="row">
>   <div className="col col--6">
>     <Image img={require("/assets/concepts/3-16.png")} alt="Android PWA minimal-ui mode 1" />
>   </div>
>   <div className="col col--6">
>     <Image img={require("/assets/concepts/3-17.png")} alt="Android PWA minimal-ui mode 2" />
>   </div>
> </div>
>
...
> <div className="row">
>   <div className="col col--6">
>     <Image img={require("/assets/concepts/3-18.png")} alt="Android PWA standalone mode 1" />
>   </div>
>   <div className="col col--6">
>     <Image img={require("/assets/concepts/3-19.png")} alt="Android PWA standalone mode 2" />
>   </div>
> </div>
...
<div className="row">
  <div className="col col--6">
    <Image img={require("/assets/concepts/3-24.png")} alt="Scene Properties Example 1" />
  </div>
  <div className="col col--6">
    <Image img={require("/assets/concepts/3-25.png")} alt="Scene Properties Example 2" />
  </div>
</div>
