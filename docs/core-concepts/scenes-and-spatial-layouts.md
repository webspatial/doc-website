...
<div className="row">
  <div className="col col--6">
    <Image img="/assets/concepts/3-1.png" alt="Scene Example 1" />
  </div>
  <div className="col col--6">
    <Image img="/assets/concepts/3-2.png" alt="Scene Example 2" />
  </div>
</div>
...
<Image img="/assets/concepts/3-3.png" alt="Scene Example 3" />
...
<Image img="/assets/concepts/3-4.png" alt="Scene Example 3" />
<Image img="/assets/concepts/3-5.png" alt="Scene Example 3" />
...
<Image img="/assets/concepts/3-6.png" alt="Scene Example 3" />
<Image img="/assets/concepts/3-7.png" alt="Scene Example 3" />
...
<Image img="/assets/concepts/3-8.png" alt="Scene Example 3" />
...
<Image img="/assets/concepts/3-9.png" alt="Scene Example 3" />
<Image img="/assets/concepts/3-10.png" alt="Scene Example 3" />
...
<Image img="/assets/concepts/3-11.png" alt="Scene Example 3" />
...
> <div className="row">
>   <div className="col col--6">
>     <Image img="/assets/concepts/3-12.png" alt="Non-spatial version" />
>   </div>
>   <div className="col col--6">
>     <Image img="/assets/concepts/3-13.png" alt="Spatial version with transparent background" />
>   </div>
> </div>
...
<Image img="/assets/concepts/3-14.png" alt="Scene Example 3" />
...
> <Image img="/assets/concepts/3-15.png" alt="Scene Example 3" />
>
> The following images show an Android PWA in `minimal-ui` mode (native title bar, navigation buttons inside the menu).
>
> <div className="row">
>   <div className="col col--6">
>     <Image img="/assets/concepts/3-16.png" alt="Android PWA minimal-ui mode 1" />
>   </div>
>   <div className="col col--6">
>     <Image img="/assets/concepts/3-17.png" alt="Android PWA minimal-ui mode 2" />
>   </div>
> </div>
>
...
> <div className="row">
>   <div className="col col--6">
>     <Image img="/assets/concepts/3-18.png" alt="Android PWA standalone mode 1" />
>   </div>
>   <div className="col col--6">
>     <Image img="/assets/concepts/3-19.png" alt="Android PWA standalone mode 2" />
>   </div>
> </div>
...
<Image img="/assets/concepts/3-20.png" alt="Scene Example 3" />
...
<Image img="/assets/concepts/3-21.png" alt="Scene Example 3" />
...
<Image img="/assets/concepts/3-22.png" alt="Scene Example 3" />
<Image img="/assets/concepts/3-23.png" alt="Scene Example 3" />
...
<div className="row">
  <div className="col col--6">
    <Image img="/assets/concepts/3-24.png" alt="Scene Properties Example 1" />
  </div>
  <div className="col col--6">
    <Image img="/assets/concepts/3-25.png" alt="Scene Properties Example 2" />
  </div>
</div>
...
<div className="row">
  <div className="col col--6">
    <Image img="/assets/concepts/3-26.gif" alt="Spatial Layout Example 1" />
  </div>
  <div className="col col--6">
    <Image img="/assets/concepts/3-27.gif" alt="Spatial Layout Example 2" />
  </div>
</div>
...
> <div className="row">
>   <div className="col col--6">
>     <Image img="/assets/concepts/3-28.png" alt="Scene Initialization Example 1" />
>   </div>
>   <div className="col col--6">
>     <Image img="/assets/concepts/3-29.png" alt="Scene Initialization Example 2" />
>   </div>
> </div>
...
> <Image img="/assets/concepts/3-30.png" alt="Scene Example 3" />
