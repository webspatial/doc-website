...
| <Image img="/assets/concepts/1-1.png" alt="Scene Example 1" /> | <Image img="/assets/concepts/1-2.png" alt="Scene Example 1" /> |
| :-------------------------------------------------------: | :-------------------------------------------------------: |
...
<div className="row">
  <div className="col col--6">
    <Image img="/assets/concepts/1-3.png" alt="Spatial App Example 1" />
  </div>
  <div className="col col--6">
    <Image img="/assets/concepts/1-4.png" alt="Spatial App Example 2" />
  </div>
</div>

<div className="row">
  <div className="col col--6">
    <Image img="/assets/concepts/1-5.png" alt="Spatial App Example 3" />
  </div>
  <div className="col col--6">
    <Image img="/assets/concepts/1-6.png" alt="Spatial App Example 4" />
  </div>
</div>

<div className="row">
  <div className="col col--6">
    <Image img="/assets/concepts/1-7.png" alt="Spatial App Example 5" />
  </div>
  <div className="col col--6">
    <Image img="/assets/concepts/1-8.png" alt="Spatial App Example 6" />
  </div>
</div>
...
<Image img="/assets/concepts/1-9.png" alt="image" />

Unified rendering architecture on visionOS:

<Image img="/assets/concepts/1-10.png" alt="image" />

Excerpts from the WWDC session on unified rendering:

<Image img="/assets/concepts/1-11.png" alt="image" />
<Image img="/assets/concepts/1-12.png" alt="image" />
<Image img="/assets/concepts/1-13.png" alt="image" />
:::
