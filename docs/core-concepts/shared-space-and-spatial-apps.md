...
| <Image src="/assets/concepts/1-1.png" alt="Scene Example 1" /> | <Image src="/assets/concepts/1-2.jpg" alt="Scene Example 1" /> |
| :-------------------------------------------------------: | :-------------------------------------------------------: |
...
<div className="row">
  ...
  <div className="col col--6">
    <Image src="/assets/concepts/1-4.jpg" alt="Spatial App Example 2" />
  </div>
</div>

<div className="row">
  <div className="col col--6">
    <Image src="/assets/concepts/1-5.jpg" alt="Spatial App Example 3" />
  </div>
  <div className="col col--6">
    <Image src="/assets/concepts/1-6.jpg" alt="Spatial App Example 4" />
  </div>
</div>

<div className="row">
  <div className="col col--6">
    <Image src="/assets/concepts/1-7.jpg" alt="Spatial App Example 5" />
  </div>
  <div className="col col--6">
    <Image src="/assets/concepts/1-8.jpg" alt="Spatial App Example 6" />
  </div>
</div>
...
<Image src="/assets/concepts/1-9.jpg" alt="image" />

Unified rendering architecture on visionOS:

<Image src="/assets/concepts/1-10.jpg" alt="image" />

Excerpts from the WWDC session on unified rendering:

<Image src="/assets/concepts/1-11.jpg" alt="image" />
<Image src="/assets/concepts/1-12.jpg" alt="image" />
<Image src="/assets/concepts/1-13.jpg" alt="image" />
:::
