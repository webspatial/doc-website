...
<Image img={require("/assets/quick/2.png")} alt="Scene Example 2" />
...
<Image img={require("/assets/quick/4.png")} alt="Scene Example 4" />
<Image img={require("/assets/quick/5.png")} alt="Scene Example 5" />
...
<Image img={require("/assets/quick/6.png")} alt="Scene Example 6" />
...
<Image img={require("/assets/quick/7.png")} alt="Scene Example 7" />
...
<Image img={require("/assets/quick/9.png")} alt="Scene Example 9" />
