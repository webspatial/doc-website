...
<Image img="/assets/quick/3.png" alt="Scene Example 3" />
...
<Image img="/assets/quick/4.png" alt="Scene Example 4" />
<Image img="/assets/quick/5.png" alt="Scene Example 5" />
...
<Image img="/assets/quick/6.png" alt="Scene Example 6" />
...
<Image img="/assets/quick/7.png" alt="Scene Example 7" />
...
<Image img="/assets/intro/intro-4-8.gif" alt="Scene Example 4" />
...
<Image img="/assets/quick/9.png" alt="Scene Example 9" />
...
<div className="row">
  <div className="col col--6">
    <Image img="/assets/quick/10.png" alt="" />
  </div>
  <div className="col col--6">
    <Image img="/assets/quick/11.png" alt="" />
  </div>
</div>
...
<div className="row">
  <div className="col col--6">
    <Image img="/assets/quick/12.png" alt="" />
  </div>
  <div className="col col--6">
    <Image img="/assets/quick/13.png" alt="" />
  </div>
</div>
...
<div className="row">
  <div className="col col--6">
    <Image img="/assets/quick/14.png" alt="" />
  </div>
  <div className="col col--6">
    <Image img="/assets/quick/15.png" alt="" />
  </div>
</div>
...
<div className="row">
  <div className="col col--6">
    <Image img="/assets/quick/16.png" alt="" />
  </div>
  <div className="col col--6">
    <Image img="/assets/quick/17.png" alt="" />
  </div>
</div>
