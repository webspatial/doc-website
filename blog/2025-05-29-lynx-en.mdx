...
import {default as Tab} from '@theme/TabItem';
...
<Tab label="build.gradle" value="1">
...
<Tab label="build.gradle.kts" value="2">
...
<Tabs groupId='update-lynx-3-2-with-existing-app'>
<Tab label="build.gradle" value="3">
...
<Tab label="build.gradle.kts" value="4">
