    ...
    children: [
      {
        ...
        imgUrl: ['/img/index-s2n/pc/a1.png', '/img/index-s2n/pc/a2.png'], //getFakeImg(600, 400),
        imgUrlh5: ['/img/index-s2n/h5/a1.png', '/img/index-s2n/h5/a2.png'], //getFakeImg(600, 400),
        imgUrlPad: ['/img/index-s2n/pad/a1.png', '/img/index-s2n/pad/a2.png'], //getFakeImg(600, 400),
      },
      {
        ...
        imgUrl: ['/img/index-s2n/pc/b1.png', '/img/index-s2n/pc/b2.png'], //getFakeImg(600, 400),
        imgUrlh5: ['/img/index-s2n/h5/b1.png', '/img/index-s2n/h5/b2.png'], //getFakeImg(600, 400),
        imgUrlPad: ['/img/index-s2n/pad/b1.png', '/img/index-s2n/pad/b2.png'], //getFakeImg(600, 400),
      },
      {
        ...
        imgUrl: ['/img/index-s2n/pc/c1.png', '/img/index-s2n/pc/c2.png'], // getFakeImg(600, 400),
        imgUrlh5: ['/img/index-s2n/h5/c1.png', '/img/index-s2n/h5/c2.png'], // getFakeImg(600, 400),
        imgUrlPad: ['/img/index-s2n/pad/c1.png', '/img/index-s2n/pad/c2.png'], // getFakeImg(600, 400),
      },
      {
        ...
        imgUrl: ['/img/index-s2n/pc/d1.png', '/img/index-s2n/pc/d2.png'],
        imgUrlh5: ['/img/index-s2n/h5/d1.png', '/img/index-s2n/h5/d2.png'],
        imgUrlPad: ['/img/index-s2n/pad/d1.png', '/img/index-s2n/pad/d2.png'],
      },
    ],
  },
  section3: {
